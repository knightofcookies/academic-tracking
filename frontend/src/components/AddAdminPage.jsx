...
const AddAdminPage = () => {
  ...
  const handleSubmit = (event) => {
    ...
    console.log(username, password, email, security_answer, securityQuestion);
    if (!username || !password || !email || !securityQuestion || !security_answer) {
      setErrorMessage("Missing username or password or email or security question or security answer");
      setTimeout(() => {
          setErrorMessage("");
      }, 5000);
      return;
