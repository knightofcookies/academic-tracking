...
export default function Analytics() {
    ...
    useEffect(() => {
        ...
        adminServices
            ...
            .catch((error) =>
                console.error("Error getting instructors count", error)
            );
        adminServices
            .getStudentCount()
            .then((studentCount) => {
    ...
    return (
        <SideBar>
            <div className="container">
                <div onClick={() => navigate("/analytics/departments")}>
                    <CardAnalytics
                ...
                <div onClick={() => navigate("/analytics/instructors")}>
                    <CardAnalytics
                        title={instructorCount}
                        subTitle={"Faculty"}
                        image_src={Instructor}
                    />
                </div>
                <div onClick={() => navigate("/analytics/students")}>
                    <CardAnalytics
                        title={studentCount}
                        subTitle={"Student"}
                        image_src={Student}
                ...
                <div onClick={() => navigate("/analytics/courses")}>
                    <CardAnalytics
                        title={courseCount}
                ...
                <div onClick={() => navigate("/analytics/programmes")}>
                    <CardAnalytics
                        title={programmeCount}
                        subTitle={"Programmes Offered"}
                        image_src={Programme}
                    />
                </div>
                <div onClick={() => navigate("/analytics/sessions")}>
                    <CardAnalytics
                        title={sessionCount}
                        subTitle={"Session Offered"}
                        image_src={Session}
                    />
                </div>
            </div>
